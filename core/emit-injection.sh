...
# Takes no stdin; accepts file path as $1 and hook event name as $2.
#
# Usage:
#   emit-injection.sh <ctx_state_file> <hook_event_name>
#
# Output:
...
# Build injection message based on event type
